...
<nav class="m-nav">
  <div class="m-nav-inner">
    <button class="m-nav-btn active" onclick="go('dashboard')" id="mn-dashboard" style="margin-left: 10px;">
    ...
    <button class="m-nav-btn" onclick="go('docentes')" id="mn-docentes">
    ...
    <button class="m-nav-btn" onclick="go('alumnos')" id="mn-alumnos">
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 2 4 3 6 3s6-1 6-3v-5"/></svg>
      <span>Alumnos</span>
    </button>
    <button class="m-nav-btn" onclick="go('evaluaciones')" id="mn-evaluaciones">
